 ...
 *
 * This file was automatically generated by Aegir 7.x-3.5
 * on Mon, 31 Oct 2016 13:56:07 +0700.
 *
...
if (isset($_SERVER['db_name'])) {
  ...
  */
  ...
  $conf['file_public_path'] = 'sites/angiaphat2.phanmemquanli.com/files';
  $conf['file_temporary_path'] = 'sites/angiaphat2.phanmemquanli.com/private/temp';
  $conf['file_private_path'] = 'sites/angiaphat2.phanmemquanli.com/private/files';
  $drupal_hash_salt = '';
  $conf['clean_url'] = 1;
  $conf['aegir_api'] = 3;
...
# Extra configuration from modules:
  ...
  if (is_readable('/var/aegir/platforms/angiaphat/sites/angiaphat2.phanmemquanli.com/local.settings.php')) {
    include_once('/var/aegir/platforms/angiaphat/sites/angiaphat2.phanmemquanli.com/local.settings.php');
  }
